...
class DoctrineOrmMappingsPass extends RegisterMappingsPass
{
     ...
     *                                    to this list.
     * @param string|false   $enabledParameter  Services container parameter that must be present to
     ...
     *                                    append the parameter name for the default entity manager
     *                                    to this list.
     * @param string   $enabledParameter  Services container parameter that must be present to
     *                                    enable the mapping. Set to false to not do any check,
     *                                    optional.
     * @param string[] $aliasMap          Map of alias to namespace.
     *
