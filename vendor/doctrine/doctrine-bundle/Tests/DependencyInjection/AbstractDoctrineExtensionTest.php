...
abstract class AbstractDoctrineExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Assertion on the Class of a DIC Services Definition.
     *
    ...
    {
        $this->assertEquals($expectedClass, $definition->getClass(), 'Expected Class of the DIC Container Services Definition is wrong.');
    }

    private function assertDICConstructorArguments(Definition $definition, $args)
    {
        $this->assertEquals($args, $definition->getArguments(), "Expected and actual DIC Services constructor arguments of definition '".$definition->getClass()."' don't match.");
    }
