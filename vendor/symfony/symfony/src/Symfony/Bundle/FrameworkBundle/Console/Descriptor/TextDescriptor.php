...
class TextDescriptor extends Descriptor
{
    ...
    protected function describeContainerService($service, array $options = array())
    {
        ...
        if ($service instanceof Alias) {
            ...
            $options['output']->title(sprintf('Information for Services "<info>%s</info>"', $options['id']));
            $options['output']->table(
                array('Services ID', 'Class'),
                array(
    ...
    protected function describeContainerServices(ContainerBuilder $builder, array $options = array())
    {
        ...
        $tableHeaders = array_merge(array('Services ID'), $tagsNames, array('Class name'));
        $tableRows = array();
    ...
    protected function describeContainerDefinition(Definition $definition, array $options = array())
    {
        ...
        $tableRows[] = array('Services ID', isset($options['id']) ? $options['id'] : '-');
        ...
        if ($factory = $definition->getFactory()) {
            if (is_array($factory)) {
                if ($factory[0] instanceof Reference) {
                    $tableRows[] = array('Factory Services', $factory[0]);
